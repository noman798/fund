...
var factory = function (signals) {
    ...
    Crossroads.prototype = {
        ...
        resetState : function(){
            ...
            this._prevMatchedRequest = undefined;
            this._prevBypassedRequest = undefined;
        },
        ...
        parse : function (request, defaultArgs) {
            ...
            if (n) {
                ...
                while (i < n) {
                    cur = routes[i];
                    cur.route.matched.send.apply(cur.route.matched, defaultArgs.concat(cur.params));
                    cur.isFirst = !i;
                    this.routed.send.apply(this.routed, defaultArgs.concat([request, cur]));
                    i += 1;
                }
            } else {
                this._prevBypassedRequest = request;
                this._prevMatchedRequest = undefined;
                this.bypassed.send.apply(this.bypassed, defaultArgs.concat([request]));
            }
        ...
        _notifyPrevRoutes : function(matchedRoutes, request) {
            ...
            while (prev = this._prevRoutes[i++]) {
                ...
                if(prev.route.switched && this._didSwitch(prev.route, matchedRoutes)) {
                    prev.route.switched.send(request);
                }
            }
        },
        ...
        _getMatchedRoutes : function (request) {
            ...
            while (route = routes[--n]) {
                //console.log(request, route, route.match(request),"!!!!");
    ...
    function Route(pattern, callback, priority, router) {
        ...
        this.matched = Signal();
        this.switched = Signal();
        if (callback) {
            this.matched.bind(callback);
        }
